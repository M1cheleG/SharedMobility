...
public class TestSharedMobility {
    public static void main(String[] args) {
        ...
        app.signinUser(new User(UUID.fromString("4e23ad1c-fc29-45dc-a4e6-f77b969758c8"),"Mario","Rossi", LocalDate.parse("2000-10-05"),"c3d4", List.of(DrivingLicense.B,DrivingLicense.BSPECIAL),false,100));
        app.signinUser(new User(UUID.fromString("961f8d13-eedb-4303-b254-fd02c2aed2eb"),"Gaspare","Bianchi", LocalDate.parse("1999-09-04"),"c3d4", List.of(DrivingLicense.A,DrivingLicense.ASPECIAL),true,1000));
        app.signinUser(new User(UUID.fromString("9637a735-86b4-42d2-9559-a06be12a6d4a"),"Ilario","Verdi", LocalDate.parse("1998-08-03"),"c3d4", List.of(DrivingLicense.C,DrivingLicense.CSPECIAL),false,10));
        ...
        Vehicle veicolo4 = new Scooter(UUID.fromString("2d5ab7b5-2c92-4525-8a1d-f13a2102304e"), "Roma",1, Helmet.MOTOSCOOTER);
        ...
        System.out.println(app.getVehicles());
